        ...
        <section>
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    Группа: <abbr title="Информационные системы/бюджет-31-очное отделение обучения">ИС/б-31-о</abbr>
                    <br>
                    <hr>
                    <div class="text-center"><h4>Лабораторная работа №7+ WEB </h4></div>
                    <br>
                    <div class="text-center"><h5>
                            Переработка для использования на фреймворке beego
                        </h5>
                    </div>
                    <br>
                    <hr>
